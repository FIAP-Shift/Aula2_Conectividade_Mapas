...
class _MapaState extends State<Mapa> {
  ...
  //função que itera sobre as posições geográficas, construíndo o ponto mais a nordeste e sudoeste
  ...
  Widget build(BuildContext context) {
    buildPositionVariables(context);
  ...
  void buildPositionVariables(BuildContext context){
